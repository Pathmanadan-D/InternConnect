            ...
            {rows.map((r) => (
              <tr key={r.id} className="border-t border-gray-200">
                ...
                <td className="px-4 py-3">
                  <button className="px-3 py-1.5 rounded-lg bg-white hover:bg-gray-50 border border-gray-200 mr-2">Edit</button>
                  <button className="px-3 py-1.5 rounded-lg bg-red-500/90 hover:bg-red-500 text-white">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
